...
//	static Logger logger = Logger.getLogger(MediaController.class);
	 ...
	 */
	public void exit() {
		int option = JOptionPane.showConfirmDialog(this.mainFrame, "是否要退出myDownloader下载器？",
				"系统提示", JOptionPane.YES_NO_OPTION,
				JOptionPane.QUESTION_MESSAGE);
		if (option == JOptionPane.YES_OPTION) {
			System.out.println(" 我还想做些什么………… ");
         	/*退出前暂停所有正在运行的任务*/
			this.pauseAll();
         	
         	/*记录日志*/
			// 	logger.info(" myDownloader退出！");
